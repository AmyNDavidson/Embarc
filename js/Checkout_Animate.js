    ...
    loader.addEventListener( 'load', function ( event ) {
        ...
        console.log("event.index value: "+ index);
  	    ...
  	    switch (index) {
            ...
            case 0:
                    if(chklen == true){
                        var material0 = new THREE.MeshPhongMaterial( { ambient: 0x3B95E3, color: 0x3B95E3, specular: 0x111111, shininess: 200 } );
            ...
            case 1:
                    var material1 = new THREE.MeshPhongMaterial( { ambient: 0x3B95E3, color: 0x3B95E3, specular: 0x111111, shininess: 200 } );
                    var mesh1 =  new THREE.Mesh( geometry, material1 );
                    mesh1.castShadow = true;
                    mesh1.receiveShadow = true;
                    //console.log("mesh"+index+".position: "+ myPositions[index][0]+","+ myPositions[index][1]+","+ myPositions[index][2]);
                    mesh1.position.set(myPositions[index][0], myPositions[index][1], myPositions[index][2]);
                    meshGroup[index] = mesh1;
                    break;
            case 2:
