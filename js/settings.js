...
$( document ).ready(function() {
    ...
    socket.emit('client_data', Update);
      ...
      if(data.HAPTIC==1){
          $("#hapticId").html('<button  class="btn btn-lg btn-primary active" id="hapticOn">ON</button><button class="btn btn-lg" id="hapticOff">OFF</button>');
      }else{
          $("#hapticId").html('<button  class="btn btn-lg" id="hapticOn">ON</button><button  id="hapticOff" class="btn btn-lg btn-primary active">OFF</button>');
      } 
      if(data.HEADLIGHT==1){
          $("#headlightId").html('<button  class="btn btn-lg btn-primary active" id="headlightOn">ON</button><button class="btn btn-lg" id="headlightOff">OFF</button>');
      }else{
          $("#headlightId").html('<button  class="btn btn-lg" id="headlightOn">ON</button><button  id="headlightOff" class="btn btn-lg btn-primary active">OFF</button>');
      } 
...
function setSettings(){
    ...
    if($("#hapticOn").attr("class")=="btn btn-lg btn-primary active" || $("#hapticOn").attr("class")=="btn btn-lg btn-primary"){
      Settings.HAPTIC = 1;
    }else{
       Settings.HAPTIC = 0
    }
    if($("#headlightOn").attr("class")=="btn btn-lg btn-primary active" || $("#headlightOn").attr("class")=="btn btn-lg btn-primary"){
