    ...
    GetSettings();
     ...
     // console.log("checkOutType is : "+checkOutType);  
        ...
        $("#continueButton").click(function(){
            ...
            //console.log("continueButton click func() called");

            var value = $("#continueText").val();

           // console.log("continueText value is==>"+value);
...
/*
 ...
 {
    //console.log("TakeAPoint func() called");
    TakePointSound();
      ...
      switch(MeasureStep)
      {
       ...
       if(MeasureStep==0){
         ...
         $("#pointsTakenId").val(pts1.length);
               ...
               // console.log(" Original Data Angles: " + data.Angles );
